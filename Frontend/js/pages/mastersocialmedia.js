const MasterSocialMedia = {
  render() {
    return `
      <main class="master-social" style="background:#080808;color:#efe6d6;min-height:80vh;padding:40px 20px;">
        <style>
          .msm-hero{ max-width:1200px; margin:0 auto 28px; display:flex; flex-direction:column; gap:18px; align-items:center; }
          .msm-hero-visual{ width:50%; max-width:600px; border-radius:20px; overflow:hidden; box-shadow:0 30px 80px rgba(0,0,0,0.6); }
          .msm-hero-visual img{ width:100%; height:auto; display:block; }
          .msm-separator{
            width:100%;
            max-width:1200px;
            margin:48px auto;
            height:2px;
            background:linear-gradient(90deg, transparent, rgba(212,169,85,0.6), transparent);
          }
          ...
          .mas-video .poster{ display:block; width:100%; height:100%; background-image:url('assets/images/master-social-media.png'); background-size:cover; background-position:center; padding-bottom:62%; }
          ...
          .mas-toc-column ul{ list-style:none; margin:0; padding:0; }
          ...
          .mas-section4{ width:100%; max-width:1200px; margin:0 auto; box-sizing:border-box; padding:48px 20px; }
          .mas-section4-inner{ width:100%; }
          .mas-section4-title{ text-align:center; color:#efe6d6; font-size:32px; margin-bottom:24px; }
          .mas-section4-separator{ 
            width:100%; 
            height:3px; 
            background:linear-gradient(90deg, rgba(212,169,85,0.8), rgba(212,169,85,0.4)); 
            margin:28px 0; 
            border-radius:2px; 
          }
          ...
          .mas-section5{ width:100%; max-width:1200px; margin:0 auto; box-sizing:border-box; padding:48px 20px; }
          .mas-section5-inner{ width:100%; text-align:center; }
          ...
          @media (max-width:980px){
            .msm-hero-visual{ width:100%; max-width:1100px; }
            .msm-separator{ margin:32px auto; }
          }
        </style>

        <div class="msm-hero">
          <div class="msm-hero-visual" aria-hidden="false">
            <img src="assets/images/master-social-media.png" alt="Social Media Management Master">
          </div>
        </div>

        <div class="msm-separator" aria-hidden="true"></div>

        <div class="mas-feature" aria-hidden="false">
          <div class="mas-feature-inner">
            <div class="left">
              <div class="mas-badge">Conoce mas</div>
              <h1 class="title-main">SOCIAL MEDIA MANAGEMENT</h1>
              <div class="subtitle">Master avalado por el Modern Wealth Institute</div>
              <p class="lead">El Master de Social Media Management es un programa integral 
que te enseña a gestionar, hacer crecer y monetizar presencias digitales 
en redes sociales. Aprenderás estrategias de contenido, community management, 
publicidad digital, analítica avanzada y cómo generar resultados medibles 
para marcas personales o empresas. Este master te prepara para convertirte 
en un profesional altamente demandado en la economía digital.</p>
              <div class="achievements">
                <h3>Logros alcanzados</h3>
                <ul>
                  <li>Dominar estrategias de contenido para múltiples plataformas.</li>
                  <li>Crear y ejecutar campañas publicitarias efectivas.</li>
                  <li>Gestionar comunidades y construir audiencias comprometidas.</li>
                  <li>Analizar métricas y optimizar resultados constantemente.</li>
                </ul>
              </div>
            </div>
            <div class="mas-video" role="button" aria-label="Ver video">
              ...
              <div class="play">▶</div>
              <div class="label">Master Social Media Management</div>
            </div>
          </div>
        </div>
          ...
          <div class="mas-contents-inner">
            ...
            <div class="mas-toc" role="navigation" aria-label="Tabla de contenido">
              <div class="mas-toc-column">
                <ul>
                  <li>1. Fundamentos de Social Media</li>
                  <li class="small">1.1 Ecosistema digital y redes sociales principales</li>
                  <li class="small">1.2 Algoritmos y cómo funcionan las plataformas</li>
                  <li class="small">1.3 Psicología del usuario en redes sociales</li>
                  <li class="small">1.4 Tendencias actuales y futuras</li>
                  <li>2. Estrategia de Contenido</li>
                  <li class="small">2.1 Definición de objetivos y audiencia</li>
                  <li class="small">2.2 Creación de calendario editorial</li>
                  <li class="small">2.3 Tipos de contenido según plataforma</li>
                  <li class="small">2.4 Storytelling y narrativa visual</li>
                  <li class="small">2.5 Copywriting para redes sociales</li>
                  <li>3. Producción de Contenido</li>
                  <li class="small">3.1 Fotografía y video para redes sociales</li>
                  <li class="small">3.2 Herramientas de diseño y edición</li>
                  <li class="small">3.3 Creación de contenido viral</li>
                  <li class="small">3.4 Reels, Stories, TikToks y formatos emergentes</li>
                  <li>4. Community Management</li>
                  <li class="small">4.1 Construcción y gestión de comunidades</li>
                  <li class="small">4.2 Engagement y interacción estratégica</li>
                  <li class="small">4.3 Manejo de crisis y comentarios negativos</li>
                  <li class="small">4.4 Moderación y protocolos de respuesta</li>
                </ul>
              </div>
              <div class="mas-toc-column">
                <ul>
                  <li>5. Publicidad en Redes Sociales</li>
                  <li class="small">5.1 Meta Ads (Facebook e Instagram)</li>
                  <li class="small">5.2 TikTok Ads y campañas virales</li>
                  <li class="small">5.3 LinkedIn Ads para B2B</li>
                  <li class="small">5.4 YouTube Ads y estrategia de video</li>
                  <li class="small">5.5 Optimización de presupuesto y ROAS</li>
                  <li>6. Analítica y Métricas</li>
                  <li class="small">6.1 KPIs esenciales por plataforma</li>
                  <li class="small">6.2 Herramientas de analítica avanzada</li>
                  <li class="small">6.3 Interpretación de datos y reportes</li>
                  <li class="small">6.4 A/B testing y optimización continua</li>
                  <li>7. Monetización y Crecimiento</li>
                  <li class="small">7.1 Modelos de monetización en redes sociales</li>
                  <li class="small">7.2 Marketing de influencers y colaboraciones</li>
                  <li class="small">7.3 Estrategias de crecimiento orgánico</li>
                  <li class="small">7.4 Escalado de cuentas y marcas personales</li>
                  <li>8. Gestión Profesional</li>
                  <li class="small">8.1 Herramientas de gestión y automatización</li>
                  <li class="small">8.2 Trabajo con clientes y agencias</li>
                  <li class="small">8.3 Propuestas comerciales y cotizaciones</li>
                  <li class="small">8.4 Construcción de portafolio profesional</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section class="mas-section4" aria-labelledby="mas-section4-title">
          <div class="mas-section4-inner">
            <h2 id="mas-section4-title" class="mas-section4-title">Herramientas clave del Social Media Manager profesional</h2>
            <div class="mas-section4-separator" aria-hidden="true"></div>

            <div class="mas-section4-block">
              <div class="mas-section4-image">
                <img src="assets/images/img1social.png" alt="Dashboard de métricas">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">ANALÍTICA AVANZADA</div>
                <h3>Dashboard de métricas en tiempo real</h3>
                <p>Monitorea el rendimiento de todas tus cuentas desde 
un solo lugar, identifica contenido top performer y 
toma decisiones basadas en datos reales.</p>
              </div>
            </div>
            ...
            <div class="mas-section4-block reverse">
              <div class="mas-section4-image">
                <img src="assets/images/img2social.png" alt="Calendario de contenido">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">PLANIFICACIÓN ESTRATÉGICA</div>
                <h3>Sistema de calendario editorial</h3>
                <p>Organiza, programa y gestiona tu contenido de forma 
profesional con herramientas que optimizan tu tiempo 
y mantienen consistencia en todas las plataformas.</p>
              </div>
            </div>
            ...
            <div class="mas-section4-block">
              <div class="mas-section4-image">
                <img src="assets/images/img3social.png" alt="Campañas publicitarias">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">PUBLICIDAD DIGITAL</div>
                <h3>Gestión de campañas publicitarias</h3>
                <p>Domina las plataformas publicitarias de Meta, TikTok 
y LinkedIn para crear campañas rentables con ROI 
medible y escalable.</p>
            ...
            <div class="mas-testimonials-grid">
              <div class="mas-testimonial-card">
                ...
                <div class="mas-testimonial-user">
                  <img src="assets/images/testimonial-andrea.jpg" alt="Andrea Torres">
                  <div class="info">
                    <div class="name">Andrea Torres</div>
                    <div class="year">Suscrita el 2024</div>
                  </div>
                </div>
              </div>
              ...
              <div class="mas-testimonial-card">
                ...
                <div class="mas-testimonial-user">
                  <img src="assets/images/testimonial-diego.jpg" alt="Diego Martínez">
                  <div class="info">
                    <div class="name">Diego Martínez</div>
  ...
  after_render() {
    ...
    if (tocElement) tocObserver.observe(tocElement);
  }
};

if (typeof window !== 'undefined') window.MasterSocialMedia = MasterSocialMedia;
if (typeof module !== 'undefined' && module.exports) module.exports = MasterSocialMedia;
