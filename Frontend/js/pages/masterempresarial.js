const MasterEmpresarial = {
  render() {
    return `
      <main class="master-empresarial" style="background:#080808;color:#efe6d6;min-height:80vh;padding:40px 20px;">
        <style>
          .mem-hero{ max-width:1200px; margin:0 auto 28px; display:flex; flex-direction:column; gap:18px; align-items:center; }
          .mem-hero-visual{ width:50%; max-width:600px; border-radius:20px; overflow:hidden; box-shadow:0 30px 80px rgba(0,0,0,0.6); }
          .mem-hero-visual img{ width:100%; height:auto; display:block; }
          .mem-separator{
            width:100vw;
          ...
          .mas-video .poster{ display:block; width:100%; height:100%; background-image:url('assets/images/master-gestion-empresarial.png'); background-size:cover; background-position:center; padding-bottom:62%; }
          ...
          @media (max-width:980px){
            .mem-hero-visual{ width:100%; max-width:1100px; }
            .mem-separator{ height:400px; margin-top:400px; margin-bottom:400px; }
          }
        </style>

        <div class="mem-hero">
          <div class="mem-hero-visual" aria-hidden="false">
            <img src="assets/images/master-gestion-empresarial.png" alt="Dirección Empresarial Master">
          </div>
        </div>

        <div class="mem-separator" aria-hidden="true"></div>

        <div class="mas-feature" aria-hidden="false">
          <div class="mas-feature-inner">
            <div class="left">
              <div class="mas-badge">Conoce mas</div>
              <h1 class="title-main">DIRECCIÓN EMPRESARIAL</h1>
              <div class="subtitle">Master avalado por el Modern Wealth Institute</div>
              <p class="lead">Operación, Gestión y Dirección Empresarial es un programa diseñado
para formar criterio directivo y capacidad real de administración
empresarial, integrando la operación diaria, la gestión de recursos y 
la toma de decisiones estratégicas. El master desarrolla una visión 
estructurada de la empresa, permitiendo comprender cómo funcionan 
los procesos internos, cómo se organizan los equipos y cómo se dirige 
una organización con orden, control y propósito, más allá de la 
improvisación o la intuición.</p>
<div class="achievements">
                <h3>Logros alcanzados</h3>
                <ul>
                  <li>Comprender la empresa como un sistema integral.</li>
                  <li>Estructurar procesos operativos y administrativos.</li>
                  <li>Fortalecer la toma de decisiones directivas.</li>
                  <li>Desarrollar una visión clara de gestión y control empresarial.</li>
                </ul>
              </div>
            </div>
            <div class="mas-video" role="button" aria-label="Ver video">
              ...
              <div class="play">▶</div>
              <div class="label">Master Dirección Empresarial</div>
            </div>
          </div>
        </div>
          ...
          <div class="mas-contents-inner">
            ...
            <div class="mas-toc" role="navigation" aria-label="Tabla de contenido">
              <div class="mas-toc-column">
                <ul>
                  <li>1. Visión Integral de la Empresa.</li>
                  <li class="small">1.1 La empresa como sistema organizacional</li>
                  <li class="small">1.2 Relación entre operación, gestión y dirección</li>
                  <li class="small">1.3 Objetivos empresariales y alineación estratégica</li>
                  <li class="small">1.4 Ciclos de planificación y control</li>
                  <li>2. Estructura Organizacional y Roles.</li>
                  <li class="small">2.1 Diseño de estructuras organizativas</li>
                  <li class="small">2.2 Definición de funciones y responsabilidades</li>
                  <li class="small">2.3 Coordinación entre áreas</li>
                  <li class="small">2.4 Delegación y niveles de autoridad</li>
                  <li>3. Gestión de Procesos Operativos<./li>
                  <li class="small">3.1 Identificación y mapeo de procesos</li>
                  <li class="small">3.2 Estandarización y documentación</li>
                  <li class="small">3.3 Indicadores operativos (KPIs)</li>
                  <li class="small">3.4 Mejora continua y eficiencia operativa</li>
                  <li class="small">3.5 Control de calidad y desempeño</li>
                  <li>4. Gestión Administrativa y Financiera</li>
                  <li class="small">4.1 Principios de administración empresarial</li>
                  <li class="small">4.2 Control presupuestal y flujo de caja</li>
                  <li class="small">4.3 Análisis financiero para directivos</li>
                  <li class="small">4.4 Toma de decisiones basada en información inanciera.</li>
                </ul>
              </div>
              <div class="mas-toc-column">
                <ul>
                  <li>5. Dirección Estratégica</li>
                  <li class="small">5.1 Planeación estratégica empresarial</li>
                  <li class="small">5.2 Análisis del entorno y del negocio</li>
                  <li class="small">5.3 Definición de objetivos estratégicos</li>
                  <li class="small">5.4 Seguimiento y ajuste de la estrategia</li>
                  <li>6. Gestión del Talento y Liderazgo.</li>
                  <li class="small">6.1 Gestión del talento humano</li>
                  <li class="small">6.2 Liderazgo organizacional</li>
                  <li class="small">6.3 Comunicación interna efectiva</li>
                  <li class="small">6.4 Evaluación del desempeño</li>
                  <li class="small">6.5 Cultura organizacional</li>
                  <li>7. Control, Indicadores y Toma de Decisiones</li>
                  <li class="small">7.1 Sistemas de control de gestión</li>
                  <li class="small">7.2 Cuadros de mando e indicadores clave</li>
                  <li class="small">7.3 Análisis de resultados</li>
                  <li class="small">7.4 Toma de decisiones directivas</li>
                  <li>8. Gestión del Cambio y Crecimiento Empresarial</li>
                  <li class="small">8.1 Adaptación al cambio organizacional</li>
                  <li class="small">8.2 Gestión del crecimiento empresarial</li>
                  <li class="small">8.3 Escalamiento de operaciones</li>
                  <li class="small">8.4 Sostenibilidad y continuidad del negocio</li>
                  <li>9. Profesionalización de la Dirección</li>
                  <li class="small">9.1 Rol del directivo moderno</li>
                  <li class="small">9.2 Ética y responsabilidad empresarial</li>
                  <li class="small">9.3 Gobierno corporativo básico</li>
                  <li class="small">9.4 Visión de largo plazo y sucesión</li>
                  <li>10. Extras - actualizaciones</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section class="mas-section4" aria-labelledby="mas-section4-title">
          <div class="mas-section4-inner">
            <h2 id="mas-section4-title" class="mas-section4-title">Gestiona y lidera con éxito empresas y organizaciones</h2>
            ...
            <div class="mas-section4-block">
              <div class="mas-section4-image">
                <img src="assets/images/img1empresa.png" alt="VENTAS DIARIAS">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">LIDERAZGO</div>
                <h3>Liderazgo efectivo y toma de decisiones</h3>
                <p>Desarrollo de habilidades de gestión para
comunicarse, coordinar equipos y tomar
decisiones estratégicas</p>
            ...
            <div class="mas-section4-block reverse">
              <div class="mas-section4-image">
                <img src="assets/images/img2empresa.png" alt="Paso 2">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">SEGURIDAD INDUSTRIAL</div>
                <h3>Optimización de procesos y seguridad</h3>
                <p>Mejora la excelencia operacional y la gestión
del riesgo para proteger los intereses de los 
empleados y la continuidad del negocio</p>
              </div>
            </div>
            ...
            <div class="mas-section4-block">
              <div class="mas-section4-image">
                <img src="assets/images/img3empresa.png" alt="Paso 3">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">TALENTO HUMANO</div>
                <h3>Gestión de personal efectivo</h3>
                <p>Parámetros ideales para la selección
de un personal efectivo</p>
              </div>
            </div>
...
if (typeof window !== 'undefined') window.MasterEmpresarial = MasterEmpresarial;
if (typeof module !== 'undefined' && module.exports) module.exports = MasterEmpresarial;
