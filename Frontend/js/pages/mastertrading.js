const MasterTrading = {
  render() {
    return `
      <main class="master-trading" style="background:#080808;color:#efe6d6;min-height:80vh;padding:40px 20px;">
        <style>
          .mtr-hero{ max-width:1200px; margin:0 auto 28px; display:flex; flex-direction:column; gap:18px; align-items:center; }
          /* Reducir imagen hero al 50% del ancho en escritorio, mantener responsive en móvil */
          .mtr-hero-visual{ width:50%; max-width:600px; border-radius:20px; overflow:hidden; box-shadow:0 30px 80px rgba(0,0,0,0.6); }
          .mtr-hero-visual img{ width:100%; height:auto; display:block; }
          ...
          .mas-feature h1.title-main{ font-size:28px; margin:0 0 12px; color:#d4a955; letter-spacing:2px; }
          ...
          .mas-video .poster{ display:block; width:100%; height:100%; background-image:url('assets/images/master-trading.png'); background-size:cover; background-position:center; padding-bottom:62%; } /* aspect */
         ...
         <div class="mas-feature" aria-hidden="false">
          <div class="mas-feature-inner">
            <div class="left">
              ...
              <h1 class="title-main">GESTIÓN DE CAPITAL EN MERCADOS FINANCIEROS</h1>
              <div class="subtitle">Master avalado por el Modern Wealth Institute</div>
              <p class="lead">Gestión de Capital en Mercados Financieros es un programa formativo
diseñado para quienes desean operar los mercados con método, 
disciplina y criterio profesional. Aprenderás a analizar el mercado, 
gestionar el riesgo y tomar decisiones estratégicas, dejando atrás la
improvisación y el azar, para construir un proceso de operativa
consistente y sostenible en el tiempo.</p>
              <div class="achievements">
                <h3>Logros alcanzados</h3>
                <ul>
                  <li>Comprender y analizar la estructura del mercado para tomar decisiones basadas en lógica y contexto, no en impulsos.</li>
                  <li>Aplicar una gestión de capital sólida y controlada, protegiendo el capital ante escenarios adversos.</li>
                  <li>Ejecutar operaciones con reglas claras, manteniendo disciplina, consistencia y control emocional.</li>
                  <li>Desarrollar un plan de trading profesional, enfocado en sostenibilidad y crecimiento a largo plazo.</li>
                </ul>
              </div>
            </div>
          ...
          <div class="mas-contents-inner">
            ...
            <div class="mas-toc" role="navigation" aria-label="Tabla de contenido">
              <div class="mas-toc-column">
                <ul>
                  <li>1. Fundamentos del mercado financiero</li>
                  <li class="small">1.1 Qué es realmente el mercado financiero</li>
                  <li class="small">1.2 Participantes del mercado (retail vs institucional)</li>
                  <li class="small">1.3 Tipos de mercado (Forex - indices - acciones - cripto)</li>
                  <li class="small">1.4 Horarios, sesionoes y liquidez</li>
                  <li class="small">1.5 Mitos comunes del trading</li>
                  <li>2. Estructura del mercado</li>
                  <li class="small">2.1 Tendencias, rango y transiciones</li>
                  <li class="small">2.2 Maximos y minimos relevantes</li>
                  <li class="small">2.3 Estructura alcista vs bajista</li>
                  <li class="small">2.4 Rupturas reales vs falsas</li>
                  <li class="small">2.5 Contexto antes de operar</li>
                  <li>3. Oferta, demanda y liquidez</li>
                  <li class="small">3.1 Qué es liquidez y por qué mueve el mercado</li>
                  <li class="small">3.2 Zonas de oferta y demanda</li>
                  <li class="small">3.3 Barridos de liquidez</li>
                  <li class="small">3.4 Trampas del mercado</li>
                  <li class="small">3.5 Confirmaciones validas</li>
                  <li>4. Análisis técnico funcional</li>
                  <li class="small">4.1 Soportes y resistencias bien trazados.</li>
                  <li class="small">4.2 Timeframes y su función</li>
                  <li class="small">4.3 Confluencias tecnicas</li>
                  <li class="small">4.4 Errores comunes en el análisis técnico</li>
                  <li class="small">4.5 Limpieza del tráfico (menos es más)</li>
                  <li>5. Herramientas de operativa</li>
                  <li class="small">5.1 Indicadores: Cuando si y cuando no</li>
                  <li class="small">5.2 Medias móviles y su uso correctivo</li>
                  <li class="small">5.3 RSI, MACD y osciladores (uso práctico)</li>
                  <li class="small">5.4 Price action aplicado</li>
                  <li class="small">5.5 Configuración ideal del gráfico</li>
                  <li>6. Estratedias de entrada</li>
                  <li class="small">6.1 Tipos de entrada (anticipada vs confirmada)</li>
                  <li class="small">6.2 Entradas en tendencia</li>
                  <li class="small">6.3 Entradas en rango</li>
                  <li class="small">6.4 Entradas en rompimiento</li>
                  <li class="small">6.5 Checklist antes de entrar a una operación</li>
                </ul>
              </div>
              <div class="mas-toc-column">
                <ul>
                  <li>7. Gestión del riesgo y capital</li>
                  <li class="small">7.1 Riesgo por operación</li>
                  <li class="small">7.2 Calculo de lotaje</li>
                  <li class="small">7.3 Relación riesgo beneficio</li>
                  <li class="small">7.4 Stoploss y takeprofits correctos</li>
                  <li class="small">7.5 Errores que queman cuentas</li>
                  <li>8. Psicología del trading</li>
                  <li class="small">8.1 Emociones en el trading</li>
                  <li class="small">8.2 Miedo, ansiedad y sobreoperar</li>
                  <li class="small">8.3 Disciplina y paciencia</li>
                  <li class="small">8.4 Perdidas y drawdown</li>
                  <li class="small">8.5 Mentalidad de operador profesional</li>
                  <li>9. Plan de trading profesional</li>
                  <li class="small">9.1 Qué es un plan de trading</li>
                  <li class="small">9.2 Reglas de entrada y salida</li>
                  <li class="small">9.3 Horarios de operativa</li>
                  <li class="small">9.4 Reglas del riesgo</li>
                  <li class="small">9.5 Cómo seguir el plan sin sabotearlo</li>
                  <li>10. Backtesting y optimización</li>
                  <li class="small">10.1 Qué es el backtesting</li>
                  <li class="small">10.2 Backtesting manual</li>
                  <li class="small">10.3 Registro de operaciones</li>
                  <li class="small">10.4 Métricas importantes</li>
                  <li class="small">10.5 Ajuste y mejora de estrategia</li>
                  <li>11. Ejecución en vivo (casos prácticos)</li>
                  <li class="small">11.1 Análisis completo paso a paso</li>
                  <li class="small">11.2 Ejemplo de trade ganador</li>
                  <li class="small">11.3 Ejemplo de trade perdedor</li>
                  <li class="small">11.4 Gestión durante la operación</li>
                  <li class="small">11.5 Cierre y evaluación</li>
                  <li>12. Profesionalización del trader</li>
                  <li class="small">12.1 Rutina diaria del trader</li>
                  <li class="small">12.2 Errores comunes de retail</li>
                  <li class="small">12.3 Consistencia vs suerte</li>
                  <li class="small">12.4 Escalado de cuentas</li>
                  <li class="small">12.5 Próximos pasos como operador</li>
        ...
        <section class="mas-section4" aria-labelledby="mas-section4-title">
          <div class="mas-section4-inner">
            <h2 id="mas-section4-title" class="mas-section4-title">La ciencia de proteger y hacer crecer tu capital</h2>
            ...
            <div class="mas-section4-block">
              <div class="mas-section4-image">
                <img src="assets/images/img1trading.png" alt="SEÑALES">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">SEÑALES</div>
                <h3>Identifica oportunidades en el mercado</h3>
                <p>Aprende a interpretar correctamente el precio y la acción del mercado mediante señales técnicas claras, estructuras y niveles clave para operar con mayor precisión y menor riesgo.</p>
              </div>
            </div>
            ...
            <div class="mas-section4-block reverse">
              <div class="mas-section4-image">
                <img src="assets/images/img2trading.png" alt="DISTRIBUCIÓN & LOGÍSTICA">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">DECISIONES INTELIGENTES</div>
                <h3>Toma de decisiones basadas en gestión de riesgo</h3>
                <p>Desarrolla la capacidad de ejecutar operaciones con criterio profesional, gestionando entradas, salidas y tamaño de posición para proteger el capital y mantener consistencia en el tiempo.</p>
              </div>
            </div>
            ...
            <div class="mas-section4-block">
              <div class="mas-section4-image">
                <img src="assets/images/img3trading.png" alt="GESTIÓN PUBLICITARIA">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">REPORTES FINANCIEROS</div>
                <h3>Control y análisis del rendimiento financiero</h3>
                <p>Aprende a evaluar tus resultados mediante reportes y métricas claras, analizando rendimiento, drawdown y consistencia para optimizar tu estrategia y crecer de forma sostenible.</p>
              </div>
            </div>
...
if (typeof window !== 'undefined') window.MasterTrading = MasterTrading;
if (typeof module !== 'undefined' && module.exports) module.exports = MasterTrading;
