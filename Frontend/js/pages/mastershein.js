const MasterShein = {
  render() {
    return `
      <main class="master-shein" style="background:#080808;color:#efe6d6;min-height:80vh;padding:40px 20px;">
        <style>
          .msh-hero{ max-width:1200px; margin:0 auto 28px; display:flex; flex-direction:column; gap:18px; align-items:center; }
          .msh-hero-visual{ width:50%; max-width:600px; border-radius:20px; overflow:hidden; box-shadow:0 30px 80px rgba(0,0,0,0.6); }
          .msh-hero-visual img{ width:100%; height:auto; display:block; }
          .msh-separator{
            width:100%;
            max-width:1200px;
            margin:48px auto;
          ...
          .mas-video .poster{ display:block; width:100%; height:100%; background-image:url('assets/images/master-shein-seller.png'); background-size:cover; background-position:center; padding-bottom:62%; }
          ...
          @media (max-width:980px){
            .msh-hero-visual{ width:100%; max-width:1100px; }
            .msh-separator{ margin:32px auto; }
          }
        </style>

        <div class="msh-hero">
          <div class="msh-hero-visual" aria-hidden="false">
            <img src="assets/images/master-shein-seller.png" alt="Shein Seller Master">
          </div>
        </div>

        <div class="msh-separator" aria-hidden="true"></div>

        <div class="mas-feature" aria-hidden="false">
          <div class="mas-feature-inner">
            <div class="left">
              <div class="mas-badge">Conoce mas</div>
              <h1 class="title-main">SHEIN SELLER</h1>
              <div class="subtitle">Master avalado por el Modern Wealth Institute</div>
              <p class="lead">El Master de Shein Seller es un programa completo que te enseña 
a vender en una de las plataformas de moda más grandes del mundo. 
Aprenderás a crear tu cuenta de vendedor, gestionar catálogos, 
optimizar precios, manejar inventario y logística, y posicionarte 
estratégicamente dentro del marketplace. Este master te prepara para 
operar profesionalmente en Shein desde cualquier parte del mundo.</p>
              <div class="achievements">
                <h3>Logros alcanzados</h3>
                <ul>
                  <li>Configurar y optimizar tu cuenta de vendedor en Shein.</li>
                  <li>Crear catálogos atractivos con productos de alta conversión.</li>
                  <li>Dominar estrategias de pricing y gestión de márgenes.</li>
                  <li>Manejar logística internacional y fulfillment eficiente.</li>
                </ul>
              </div>
            </div>
            <div class="mas-video" role="button" aria-label="Ver video">
              ...
              <div class="play">▶</div>
              <div class="label">Master Shein Seller</div>
            </div>
          </div>
        </div>
          ...
          <div class="mas-contents-inner">
            ...
            <div class="mas-toc" role="navigation" aria-label="Tabla de contenido">
              <div class="mas-toc-column">
                <ul>
                  <li>1. Introducción a Shein Marketplace</li>
                  <li class="small">1.1 Qué es Shein y cómo funciona su marketplace</li>
                  <li class="small">1.2 Oportunidades y requisitos para vendedores</li>
                  <li class="small">1.3 Comisiones, cargos y estructura de costos</li>
                  <li class="small">1.4 Políticas y estándares de calidad</li>
                  <li>2. Configuración de Cuenta de Vendedor</li>
                  <li class="small">2.1 Registro y verificación paso a paso</li>
                  <li class="small">2.2 Configuración de métodos de pago</li>
                  <li class="small">2.3 Datos fiscales y documentación requerida</li>
                  <li class="small">2.4 Configuración de políticas de envío</li>
                  <li>3. Gestión de Catálogo y Productos</li>
                  <li class="small">3.1 Investigación de tendencias y nichos rentables</li>
                  <li class="small">3.2 Creación de fichas de producto optimizadas</li>
                  <li class="small">3.3 Fotografía y contenido visual de alto impacto</li>
                  <li class="small">3.4 Descripciones persuasivas y SEO interno</li>
                  <li>4. Estrategias de Precio y Márgenes</li>
                  <li class="small">4.1 Análisis competitivo de precios</li>
                  <li class="small">4.2 Cálculo de costos y márgenes reales</li>
                  <li class="small">4.3 Promociones y descuentos estratégicos</li>
                  <li class="small">4.4 Optimización de rentabilidad por producto</li>
                </ul>
              </div>
              <div class="mas-toc-column">
                <ul>
                  <li>5. Logística y Fulfillment</li>
                  <li class="small">5.1 Opciones de envío y fulfillment</li>
                  <li class="small">5.2 Gestión de inventario internacional</li>
                  <li class="small">5.3 Tiempos de entrega y tracking</li>
                  <li class="small">5.4 Manejo de devoluciones y cambios</li>
                  <li>6. Atención al Cliente y Reputación</li>
                  <li class="small">6.1 Sistema de valoraciones y reviews</li>
                  <li class="small">6.2 Gestión efectiva de consultas</li>
                  <li class="small">6.3 Resolución de reclamos y disputas</li>
                  <li class="small">6.4 Construcción de reputación sólida</li>
                  <li>7. Marketing y Posicionamiento</li>
                  <li class="small">7.1 Optimización para búsquedas internas</li>
                  <li class="small">7.2 Publicidad y promociones en Shein</li>
                  <li class="small">7.3 Estrategias de visibilidad y conversión</li>
                  <li class="small">7.4 Análisis de métricas y performance</li>
                  <li>8. Escalado y Crecimiento</li>
                  <li class="small">8.1 Expansión de catálogo estratégica</li>
                  <li class="small">8.2 Automatización de procesos</li>
                  <li class="small">8.3 Diversificación de productos</li>
                  <li class="small">8.4 Planificación de crecimiento sostenible</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section class="mas-section4" aria-labelledby="mas-section4-title">
          <div class="mas-section4-inner">
            <h2 id="mas-section4-title" class="mas-section4-title">Herramientas clave del seller profesional en Shein</h2>
            <div class="mas-section4-separator" aria-hidden="true"></div>

            <div class="mas-section4-block">
              <div class="mas-section4-image">
                <img src="assets/images/img1shein.png" alt="Dashboard de ventas Shein">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">ANÁLISIS Y CONTROL</div>
                <h3>Dashboard de rendimiento</h3>
                <p>Monitorea tus ventas en tiempo real, identifica 
productos top performers y optimiza tu catálogo con 
datos precisos de conversión y rentabilidad.</p>
              </div>
            </div>
            ...
            <div class="mas-section4-block reverse">
              <div class="mas-section4-image">
                <img src="assets/images/img2shein.png" alt="Gestión de inventario">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">LOGÍSTICA GLOBAL</div>
                <h3>Sistema de fulfillment internacional</h3>
                <p>Domina la gestión de inventario, envíos internacionales 
y tiempos de entrega para ofrecer una experiencia de 
compra excepcional a nivel mundial.</p>
              </div>
            </div>
            ...
            <div class="mas-section4-block">
              <div class="mas-section4-image">
                <img src="assets/images/img3shein.png" alt="Optimización de catálogo">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">OPTIMIZACIÓN DE PRODUCTOS</div>
                <h3>Catálogo de alto impacto</h3>
                <p>Aprende a crear fichas de producto optimizadas, 
con imágenes profesionales y descripciones que 
convierten visitantes en compradores.</p>
              </div>
            </div>
            ...
            <div class="mas-testimonials-grid">
              <div class="mas-testimonial-card">
                ...
                <div class="mas-testimonial-user">
                  <img src="assets/images/testimonial-maria.jpg" alt="María González">
                  <div class="info">
              ...
              <div class="mas-testimonial-card">
                ...
                <div class="mas-testimonial-user">
                  <img src="assets/images/testimonial-sofia.jpg" alt="Sofía Ramírez">
                  <div class="info">
                    <div class="name">Sofía Ramírez</div>
                    <div class="year">Suscrita el 2025</div>
                  </div>
                </div>
              </div>
            </div>
...
if (typeof window !== 'undefined') window.MasterShein = MasterShein;
if (typeof module !== 'undefined' && module.exports) module.exports = MasterShein;
