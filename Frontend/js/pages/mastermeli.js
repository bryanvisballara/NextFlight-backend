const MasterMeli = {
  render() {
    return `
      <main class="master-meli" style="background:#080808;color:#efe6d6;min-height:80vh;padding:40px 20px;">
        <style>
          .mml-hero{ max-width:1200px; margin:0 auto 28px; display:flex; flex-direction:column; gap:18px; align-items:center; }
          .mml-hero-visual{ width:50%; max-width:600px; border-radius:20px; overflow:hidden; box-shadow:0 30px 80px rgba(0,0,0,0.6); }
          .mml-hero-visual img{ width:100%; height:auto; display:block; }
          .mml-separator{
            width:100vw;
          ...
          .mas-video .poster{ display:block; width:100%; height:100%; background-image:url('assets/images/master-meli.png'); background-size:cover; background-position:center; padding-bottom:62%; }
          ...
          @media (max-width:980px){
            .mml-hero-visual{ width:100%; max-width:1100px; }
            .mml-separator{ height:2px; margin-top:32px; margin-bottom:32px; }
          }
        </style>

        <div class="mml-hero">
          <div class="mml-hero-visual" aria-hidden="false">
            <img src="assets/images/master-meli.png" alt="Top Seller MeLi Master">
          </div>
        </div>

        <div class="mml-separator" aria-hidden="true"></div>

        <div class="mas-feature" aria-hidden="false">
          <div class="mas-feature-inner">
            <div class="left">
              <div class="mas-badge">Conoce mas</div>
              <h1 class="title-main">TOP SELLER MELI</h1>
              <div class="subtitle">Master avalado por el Modern Wealth Institute</div>
              <p class="lead">El Top Seller de MercadoLibre es un entrenamiento práctico y 
estructurado que te guía paso a paso para dominar la plataforma desde
cero hasta un nivel avanzado. Aprenderás a configurar tu cuenta
correctamente, crear publicaciones optimizadas, gestionar envíos
e inventario, posicionarte mejor dentro del marketplace y mantener 
una reputación sólida. Este master está diseñado para que entiendas 
cómo funciona MercadoLibre por dentro y sepas operar con orden, 
estrategia y profesionalismo</p>
<div class="achievements">
                <h3>Logros alcanzados</h3>
                <ul>
                  <li>Comprender a fondo el funcionamiento de MercadoLibre y su algoritmo.</li>
                  <li>Crear publicaciones optimizadas y atractivas dentro del marketplace.</li>
                  <li>Gestionar envíos, inventario y reputación de forma profesional.</li>
                  <li>Operar tu cuenta con estructura, control y visión de crecimiento.</li>
                </ul>
              </div>
            </div>
            <div class="mas-video" role="button" aria-label="Ver video">
              ...
              <div class="play">▶</div>
              <div class="label">Master Top Seller MeLi</div>
            </div>
          </div>
        </div>
          ...
          <div class="mas-contents-inner">
            ...
            <div class="mas-toc" role="navigation" aria-label="Tabla de contenido">
              <div class="mas-toc-column">
                <ul>
                  <li>1. Introducción a MercadoLibre</li>
                  <li class="small">1.1 Qué es MercadoLibre y cómo funciona</li>
                  <li class="small">1.2 Tipos de cuentas y niveles de vendedor</li>
                  <li class="small">1.3 Comisiones, cargos y costos</li>
                  <li class="small">1.4 Reglas y políticas clave</li>
                  <li class="small">1.4 Errores comunes de los principiantes</li>
                  <li>2. Creación y Configuración de la Cuenta.</li>
                  <li class="small">2.1 Apertura de cuenta paso a paso</li>
                  <li class="small">2.2 Configuración de Mercado Pago</li>
                  <li class="small">2.3 Datos fiscales y facturación</li>
                  <li class="small">2.4 Políticas de envíos y devoluciones</li>
                  <li class="small">2.5 Seguridad y protección de la cuenta</li>
                  <li>3. Publicaciones que Destacan</li>
                  <li class="small">3.1 Investigación de productos y categorías</li>
                  <li class="small">3.2 Títulos optimizados y palabras clave</li>
                  <li class="small">3.3 Fotografías que cumplen políticas y convierten</li>
                  <li class="small">3.4 Descripciones claras y persuasivas</li>
                  <li class="small">3.5 Estrategias de precio dentro del marketplace</li>
                  <li>4. Logística, Envíos e Inventario</li>
                  <li class="small">4.1 Mercado Envíos: funcionamiento y beneficios</li>
                  <li class="small">4.2 Gestión y control de inventario</li>
                  <li class="small">4.3 Preparación y despacho de pedidos</li>
                  <li class="small">4.4 Manejo de devoluciones y reclamos</li>
                  <li class="small">4.5 Optimización de tiempos de entrega</li>
                </ul>
              </div>
              <div class="mas-toc-column">
                <ul>
                  <li>5. Reputación y Atención al Cliente</li>
                  <li class="small">5.1 Cómo funciona el sistema de reputación</li>
                  <li class="small">5.2 Respuesta efectiva a preguntas</li>
                  <li class="small">5.3 Manejo de reclamos y mediaciones</li>
                  <li class="small">5.4 Estrategias para mantener calificaciones altas</li>
                  <li class="small">5.5 Prevención de sanciones y bloqueos</li>
                  <li>6. Crecimiento y Optimización</li>
                  <li class="small">6.1 Métricas clave dentro de MercadoLibre</li>
                  <li class="small">6.2 Mejora del posicionamiento en búsquedas</li>
                  <li class="small">6.3 Publicidad interna y promociones</li>
                  <li class="small">6.4 Escalado ordenado de la cuenta</li>
                  <li class="small">6.5 Organización profesional del negocio</li>
       ...
       <!-- SECCIÓN 4: bloques alternados imagen-texto con separadores -->
        <section class="mas-section4" aria-labelledby="mas-section4-title">
          <div class="mas-section4-inner">
            <h2 id="mas-section4-title" class="mas-section4-title">Herramientas clave del top seller en mercadolibre</h2>
            ...
            <div class="mas-section4-block">
              <div class="mas-section4-image">
                <img src="assets/images/img1meli.png" alt="VENTAS DIARIAS">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">CONTROL Y ESCALADO DE VENTAS</div>
                <h3>Ventas diarias inteligentes</h3>
                <p>Controla tus ingresos en tiempo real, identifica
picos de venta y toma decisiones basadas en 
datos para escalar tu facturación de forma 
constante y predecible</p>
            ...
            <div class="mas-section4-block reverse">
              <div class="mas-section4-image">
                <img src="assets/images/img2meli.png" alt="Paso 2">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">PROTEGE TU REPUTACIÓN</div>
                <h3>Reputación Top Seller</h3>
                <p>Domina los indicadores clave de Mercado Libre:
reclamos, cancelaciones y tiempos de despacho
para proteger tu cuenta y acceder a mayores
beneficios</p>
              </div>
            </div>
            ...
            <div class="mas-section4-block">
              <div class="mas-section4-image">
                <img src="assets/images/img3meli.png" alt="Paso 3">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">GESTIÓN & LOGÍSTICA AVANZADA</div>
                <h3>Logística full y envíos estratégicos</h3>
                <p>Aprende a gestionar Mercado Envíos Full,
optimizar tiempos de despacho
y aumentar la conversión con entregas
rápidas y confiables</p>
              </div>
            </div>
...
<!-- footer (incrustado manualmente, layout ajustado) -->
      <style>
        ...
        /* Centro: 'Trabaja con nosotros' centr
...
if (typeof window !== 'undefined') window.MasterMeli = MasterMeli;
if (typeof module !== 'undefined' && module.exports) module.exports = MasterMeli;
