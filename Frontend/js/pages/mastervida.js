const MasterVida = {
  render() {
    return `
      <main class="master-vida" style="background:#080808;color:#efe6d6;min-height:80vh;padding:40px 20px;">
        <style>
          .mav-hero{ max-width:1200px; margin:0 auto 28px; display:flex; flex-direction:column; gap:18px; align-items:center; }
          .mav-hero-visual{ width:50%; max-width:600px; border-radius:20px; overflow:hidden; box-shadow:0 30px 80px rgba(0,0,0,0.6); }
          .mav-hero-visual img{ width:100%; height:auto; display:block; }
          .mav-separator{
            width:100vw;
          ...
          .mas-video .poster{ display:block; width:100%; height:100%; background-image:url('assets/images/master-vida-proposito.png'); background-size:cover; background-position:center; padding-bottom:62%; }
          ...
          @media (max-width:980px){
            .mav-hero-visual{ width:100%; max-width:1100px; }
            .mav-separator{ height:400px; margin-top:400px; margin-bottom:400px; }
          }
        </style>

        <div class="mav-hero">
          <div class="mav-hero-visual" aria-hidden="false">
            <img src="assets/images/master-vida-proposito.png" alt="Vida con Propósito Master">
          </div>
        </div>

        <div class="mav-separator" aria-hidden="true"></div>

        <div class="mas-feature" aria-hidden="false">
          <div class="mas-feature-inner">
            <div class="left">
              <div class="mas-badge">Conoce mas</div>
              <h1 class="title-main">VIDA CON PROPÓSITO</h1>
              <div class="subtitle">Master avalado por el Modern Wealth Institute</div>
              <p class="lead">Vida con Propósito es un programa de formación enfocado en el desarrollo matrimonial y familiar, diseñado para acompañar a 
parejas y familias en la construcción de un hogar sólido, consciente 
y guiado por principios. A través de una visión integral que fortalece 
la relación de pareja, la crianza de los hijos y la vida espiritual, este 
master busca orientar a las familias hacia una convivencia armoniosa, 
una comunicación sana y una dirección clara, entendiendo que un 
hogar con propósito es la base para una vida con sentido, estabilidad 
y esperanza.</p>
<div class="achievements">
                <h3>Logros alcanzados</h3>
                <ul>
                  <li>Fortalecer la relación matrimonial sobre principios sólidos y conscientes.</li>
                  <li>Desarrollar una dinámica familiar basada en respeto, amor y propósito.</li>
                  <li>Mejorar la comunicación y la convivencia dentro del hogar.</li>
                  <li>Orientar la vida familiar hacia una dirección clara, con fundamento espiritual y valores.</li>
                </ul>
              </div>
            </div>
            <div class="mas-video" role="button" aria-label="Ver video">
              ...
              <div class="play">▶</div>
              <div class="label">Master Vida con Propósito</div>
            </div>
          </div>
        </div>
          ...
          <div class="mas-contents-inner">
            ...
            <div class="mas-toc" role="navigation" aria-label="Tabla de contenido">
              <div class="mas-toc-column">
                <ul>
                  <li>1. Fundamentos del matrimonio con propósito</li>
                  <li class="small">1.1 El matrimonio como proyecto de vida</li>
                  <li class="small">1.2 Principios y valores que sostienen el hogar</li>
                  <li class="small">1.3 Compromiso, respeto y unidad</li>
                  <li class="small">1.4 Construcción de una visión común</li>
                  <li>2. Comunicación y convivencia en el hogar</li>
                  <li class="small">2.1 Comunicación consciente y empática</li>
                  <li class="small">2.2 Manejo de conflictos y desacuerdos</li>
                  <li class="small">2.3 Escucha activa y acuerdos saludables</li>
                  <li class="small">2.4 Fortalecimiento del vínculo emocional</li>
                  <li>3. Crianza y formación de los hijos</li>
                  <li class="small">3.1 Rol de los padres en la formación integral</li>
                  <li class="small">3.2 Disciplina con amor y límites sanos</li>
                  <li class="small">3.3 Ejemplo, valores y acompañamiento</li>
                  <li class="small">3.4 Construcción de confianza y seguridad emocional</li>
                  <li class="small">3.5 Crianza guiada por principios</li>
                  <li>4. Vida espiritual y dirección familiar</li>
                  <li class="small">4.1 La fé como el fundamento del hogar.</li>
                  <li class="small">4.2 Caminar juntos en propósito</li>
                  <li class="small">4.3 Oración y reflexión en familia</li>
                  <li class="small">4.4 Decisiones familiares con dirección espiritual</li>
                </ul>
              </div>
              <div class="mas-toc-column">
                <ul>
                  <li>5. Crecimiento, restauración y proyección familiar</li>
                  <li class="small">5.1 Sanar heridas y fortalecer relaciones</li>
                  <li class="small">5.2 Restauración del vinculo matrimonial</li>
                  <li class="small">5.3 Construcción de un hogar resiliente</li>
                  <li class="small">5.4 Proyección familiar y legado</li>
                  <li>6. Identidad, roles y responsabilidad en familia</li>
                  <li class="small">6.1 Identidad personal y matrimonial</li>
                  <li class="small">6.2 Roles dentro del hogar</li>
                  <li class="small">6.3 Responsabilidad y corresponsabilidad familiar</li>
                  <li class="small">6.4 Equilibrio entre pareja, familia y vida personal</li>
                  <li class="small">6.5 Manejo de finanzas familiares</li>
                  <li>7. Matrimonio ejemplar y testimonio familiar</li>
                  <li class="small">7.1 El hogar como ejemplo para otros</li>
                  <li class="small">7.2 Matrimonio consciente y coherente</li>
                  <li class="small">7.3 Influencia positiva en el entorno</li>
                  <li class="small">7.4 Construcción de un testimonio familiar con propósito</li>
                  <li>8. Extras y actualizaciones</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="mas-section4-inner">
            ...
            <div class="mas-section4-block">
              <div class="mas-section4-image">
                <img src="assets/images/img1vida.png" alt="VENTAS DIARIAS">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">UNIDAD - COMPROMISO - VISION COMÚN</div>
                <h3>Contruir juntos una visión de vida</h3>
                <p>El matrimonio como un proyecto consciente,
basado en acuerdos, respeto y proposito
compartido.</p>
              </div>
            </div>
            ...
            <div class="mas-section4-block reverse">
              <div class="mas-section4-image">
                <img src="assets/images/img2vida.png" alt="Paso 2">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">EDIFICA TU HOGAR</div>
                <h3>Un hogar solido se contruye cada dia</h3>
                <p>Relaciones sanas, comunicacion consciente
y valores firmes como base de una
familia estable y armoniosa.</p>
              </div>
            </div>
            ...
            <div class="mas-section4-block">
              <div class="mas-section4-image">
                <img src="assets/images/img3vida.png" alt="Paso 3">
              </div>
              <div class="mas-section4-text">
                <div class="mas-badge">FUNDAMENTO ESPIRITUAL</div>
                <h3>La fe como ancla del propósito</h3>
                <p>La vida espiritual como guía para las
decisiones, la unidad y el crecimiento del
hogar.</p>
              </div>
            </div>
...
if (typeof window !== 'undefined') window.MasterVida = MasterVida;
if (typeof module !== 'undefined' && module.exports) module.exports = MasterVida;
